...
class ProjectDetails extends Component {
  ...
  handleSubmit = (e) => {
    ...
    mission.locationName[lang] = this.refs.locationName.value
    mission.locationType =  locationType
    mission.locationPoints =  mlp
    mission.missionType.es =  missionType
    mission.objective[lang] =  this.refs.objective.value
    ...
    mission.rally.prevMission = this.refs.rallyPrevMission.value
    mission.rally.nextMission = this.refs.rallyNextMission.value
    mission.rally.position = parseInt(this.refs.rallyPosition.value)
    mission.rally.total = parseInt(this.refs.rallyTotal.value)
    mission.rally.isRally = this.refs.rallyIsRally.checked
